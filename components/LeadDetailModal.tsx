                    ...
                    <div className="flex items-center font-semibold text-green-600">
                        ...
                        {isEditing ? (
                             <input 
                                ...
                                className="bg-white border-2 border-primary/20 rounded p-1 w-full text-sm focus:border-primary outline-none"
                            />
                        ) : (
                            formattedValue
                        )}
                ...
                <div className="flex items-center text-text-primary p-2 hover:bg-light rounded-md transition-colors">
                    ...
                    {isEditing ? (
                        <input 
                            ...
                            className="bg-white border-2 border-primary/20 rounded p-1 w-full focus:border-primary outline-none"
                    ...
                    {isEditing ? (
                        <div className="flex-1 flex items-center">
                            ...
                            <select 
                                ...
                                className="bg-white border-2 border-primary/20 rounded p-1 flex-1 focus:border-primary outline-none"
                            >
