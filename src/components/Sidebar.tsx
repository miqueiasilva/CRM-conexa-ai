...
import { Home, LayoutGrid, MessageSquare, Bot, LogOut, ChevronDown, ChevronUp, ChevronLeft, Zap, FileText, MessageCircle, X } from 'lucide-react';
    ...
    <>
      ...
      `}>
        <div className="px-6 py-8 flex items-center justify-between">
          ...
          <button 
            onClick={onClose}
            className="lg:hidden p-2 rounded-xl bg-slate-50 text-text-secondary hover:text-primary transition-colors"
          >
            <ChevronLeft size={24} />
          </button>
        </div>
